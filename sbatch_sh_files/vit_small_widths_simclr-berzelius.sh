...
destdir=$checkpt_dir/"$model_key"_width${width}/2_augs/temp_"$temperature"00_pdim_"$pdim"_bsz_"$batch_size"_lr_0.001_wd_1e-05/
...
cp -v "$destdir/exp_SimCLR_100_seed_"$seed".pt" "$SLURM_TMPDIR/exp_ssl_100.pth"
