...
src_checkpt="$checkpt_dir/resnet18/width"$width"/${naugs}_augs/temp_"$(printf %.3f $temp)"_pdim_"$pdim"_pdepth_"$pdepth"_bsz_"$batch_size"_lr_0.001_wd_1e-05/${naugs}_augs_train/exp_SimCLR_100_seed_"$seed".pt"
