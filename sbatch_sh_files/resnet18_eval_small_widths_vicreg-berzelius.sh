...
src_checkpt="$checkpt_dir/resnet18/width${width}/2_augs/lambd_"$lambd".000_mu_"$mu".000_pdim_"$pdim"_bsz_"$batch_size"_lr_0.001_wd_1e-05/exp_ssl_100_seed_"$seed".pt"
