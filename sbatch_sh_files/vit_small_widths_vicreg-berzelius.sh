...
python scripts/train_model_widthVary.py --config-file configs/cc_VICReg.yaml \
...
destdir=$checkpt_dir/"$model_key"_width${width}/2_augs/lambd_"$lambd"000_pdim_"$pdim"_bsz_"$batch_size"_lr_0.001_wd_1e-05/
...
cp -v "$destdir/exp_VICReg_100_seed_"$seed".pt" "$SLURM_TMPDIR/exp_ssl_100.pth"
