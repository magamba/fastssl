...
def split_batch_gen(data_loader, batch_size, max_samples=0, label_noise=0):
...
def input_jacobian(net, layer, data_loader, batch_size=128, max_samples=0, use_cuda=False, bigmem=True, label_noise=0):
